      ...
      <section id="how-it-works" className="mb-12">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Follow these simple steps to get your personalized workout plan
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-start space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-center text-gray-600">
              Sign up or sign in to access your personalized workout plans.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-center text-gray-600">
              Input your exercice preferences and goals to tailor your workout
              plans.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-medium mb-2">Receive Your Workout Plan</h3>
            <p className="text-center text-gray-600">
              Get your customized workout plan delivered weekly to your account.
            </p>
          </div>
        </div>
      </section>
